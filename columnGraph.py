...
def makeColumnGraph(dataframe, prs, slideName, thisTitle, slideNo, yaxis=''):
    ...
    # plt.ylabel(yaxis)
    add_value_labels(ax, typ='bar', title=slideName)
    # show the plot and save it as a figure to put into ppt
    fig = plt.savefig('columnGraph.jpg', dpi=1200, transparent=True, bbox_inches = 'tight')
    img = 'columnGraph.jpg'
