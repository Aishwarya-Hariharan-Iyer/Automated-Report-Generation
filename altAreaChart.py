...
def makeAlternateArea(dataframe, prs, slideName, thisTitle, slideNo, yaxis):
    ...
    fig = plt.savefig('altAreaChart.jpg', dpi=1200, transparent=True, bbox_inches='tight')
    img = 'altAreaChart.jpg'

    slide = prs.slides[int(slideNo) - 1]
